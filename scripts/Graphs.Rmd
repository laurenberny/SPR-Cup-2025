...
est_weighted_wide %>%
  ...
  geom_pointrange(aes(y = mean_wave4, ymin = q5_wave4, ymax = q95_wave4), color = "black") +

  # Wave 7 point + interval
  geom_point(aes(y = mean_wave7, color = "Wave 7"), size = 2) +
  geom_pointrange(aes(y = mean_wave7, ymin = q5_wave7, ymax = q95_wave7), color = "purple") +

  scale_color_manual(values = c("Wave 4" = "black", "Wave 7" = "purple")) +
  ylab("Percent EDSD E-Product Use") +
